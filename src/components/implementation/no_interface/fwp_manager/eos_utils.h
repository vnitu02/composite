...
#define EOS_MAX_CHAIN_NUM_PER_CORE 2
#define EOS_MAX_CHAIN_NUM          6/* ((EOS_MAX_CHAIN_NUM_PER_CORE * (NUM_CPU - 4)) + EOS_MAX_NF_CHAIN_TYPE_NUM) */
#define EOS_MAX_NF_TYPE_NUM        10 /* number of nf type, need such number of templates */
#define EOS_MAX_NF_NUM_PER_CORE    (6 * EOS_MAX_CHAIN_NUM_PER_CORE) /* chain length * #chains */
#define EOS_MAX_NF_NUM             50/* (2 + EOS_MAX_NF_TYPE_NUM + EOS_MAX_NF_NUM_PER_CORE * (NUM_CPU - 4)) */  /* This also includes templates, the booter and the initial component*/
#define EOS_MAX_FLOW_NUM           1500 	/* number of client flow, should equal to number of chain if we have a chain per flow */
/*we suppose having one shared sgment per chain*/
#define EOS_MAX_MEMSEGS_NUM (EOS_MAX_NF_NUM)/* EOS_MAX_CHAIN_NUM */
